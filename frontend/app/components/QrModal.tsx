      ...
      <div className="relative w-full max-w-sm bg-surface-container-lowest rounded-2xl border border-outline-variant/40 shadow-2xl p-6 z-10 animate-in fade-in zoom-in-95 duration-200 text-center">
        ...
        <div className="py-6 flex flex-col items-center">
          {loading ? (
            <div className="w-56 h-56 rounded-2xl bg-surface-container-low flex flex-col items-center justify-center gap-2 text-outline">
              <RefreshIcon size={28} className="animate-spin text-primary" />
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-outline-variant/30">
          <button
            onClick={handleCopy}
            type="button"
            className="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl border border-outline-variant/40 text-xs font-semibold text-on-surface hover:bg-surface-container-high transition-colors"
          >
          ...
          <button
            ...
            type="button"
            disabled={!qrData}
            className="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-primary-container hover:bg-primary text-on-primary text-xs font-semibold shadow-xs transition-colors disabled:opacity-50"
          >
            <QrCodeIcon size={16} />
